...
def updatecontestsubmissions(apps, schema_editor):
    ...
    Submission.objects.filter(contest_object__is_locked=True).update(is_locked=True)
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='contest',
            name='is_locked',
            field=models.BooleanField(default=False, help_text='If locked, the submissions from this contest will be locked.', verbose_name='contest lock'),
        ),
        migrations.AddField(
